    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-[hsl(var(--muted-foreground))]">请登录以管理博客内容</p>
        </div>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><div className="animate-spin w-8 h-8 border-2 border-[hsl(var(--accent))] border-t-transparent rounded-full" /></div>}>
      <LoginForm />
    </Suspense>
  )
}
